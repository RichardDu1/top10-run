...
const industries = ["CRM Systems", "ERP Software", "HR Tech", "Marketing Automation", "Cybersecurity SaaS", "Project Management", "Data Analytics SaaS"];
...
async function generateSeedTopicsBatch(batchSize = 20) {
  ...
  const prompt = `
You are a B2B SaaS Analyst for top10.run. Focus on B2B software, enterprise features, pricing tiers, and integrations.
